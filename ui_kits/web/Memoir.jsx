...
function Memoir({ go, isMobile }) {
  return (
    <div style={{ minHeight:'100%', display:'flex', flexDirection:'column', alignItems:'center',
      justifyContent:'center', textAlign:'center', padding: isMobile ? '40px 16px 80px' : '72px 24px 96px', maxWidth:920, margin:'0 auto' }}>
      ...
      <div aria-hidden="true" style={{ fontFamily:VM.serif, fontStyle:'italic', fontSize: isMobile ? 72 : 120, lineHeight:0.5,
      ...
      <h1 style={{ fontFamily:VM.serif, fontWeight:400, fontSize:'clamp(28px, 4.4vw, 50px)', lineHeight:1.28,
        ...
        {' '}&mdash; using <em style={{ color:VM.teal }}>history</em> to interpret current
        market trends, comparing them to <em style={{ color:VM.teal }}>what's happened before.</em>
      </h1>

      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:14, margin: isMobile ? '32px 0 24px' : '44px 0 30px' }}>
